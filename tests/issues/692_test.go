...
import (
	...
	clickhouse_tests "github.com/IevgenLuzan/clickhouse-go/v2/tests"
	"github.com/IevgenLuzan/clickhouse-go/v2/tests/std"
	clickhouse_std_tests "github.com/IevgenLuzan/clickhouse-go/v2/tests/std"
